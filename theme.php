<?php
	...
	class Sparse extends Theme {
		...
		public function action_init_theme ( $theme ) {
			...
			//StackItem::register( 'yui-base', 'http://yui.yahooapis.com/combo?3.8.0/build/cssfonts/cssfonts-min.css&3.8.0/build/cssreset/cssreset-min.css&3.8.0/build/cssbase/cssbase-min.css', '3.8.0' );
			StackItem::register( 'yui-fonts', 'http://yui.yahooapis.com/3.8.0/build/cssfonts/cssfonts-min.css', '3.8.0' );
			StackItem::register( 'yui-reset', 'http://yui.yahooapis.com/3.8.0/build/cssreset/cssreset-min.css', '3.8.0' )
				->add_dependency( 'yui-fonts' );

			// the responsive YUI grids that we generated get inserted in the middle
			StackItem::register( 'yui-grids-responsive', $theme->get_url( 'assets/css/grids-responsive.min.css' ) )
				->add_dependency( 'yui-reset' );

			StackItem::register( 'yui-base', 'http://yui.yahooapis.com/3.8.0/build/cssbase/cssbase-min.css', '3.8.0' )
				->add_dependency( 'yui-grids-responsive' );
			StackItem::register( 'yui-button', 'http://yui.yahooapis.com/3.8.0/build/cssbutton/cssbutton-min.css', '3.8.0' )
				->add_dependency( 'yui-base' );


			StackItem::register( 're-bootstrap', $theme->get_url( 'assets/css/re-bootstrap.css' ) );
			StackItem::register( 'theme_css', $theme->get_url( 'assets/css/style.css' ), $theme->version )
			...
			StackItem::register( 'theme_js', $theme->get_url( 'assets/js/index.js' ), $theme->version )
