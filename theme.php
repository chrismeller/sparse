<?php
	...
	class Sparse extends \Habari\Theme {
		...
		public function action_init_theme ( $theme ) {
			...
			\Habari\StackItem::register( 'bootstrap_css', 'https://b79aa4845dfa0330f3c1-8ab693c01194d150d70d8e544af6f6be.ssl.cf1.rackcdn.com/v2.1.1/full/css/bootstrap.combined.min.css', '2.1.1' );
			\Habari\StackItem::register( 'theme_css', $theme->get_url( 'assets/css/style.css' ), $theme->version )->add_dependency( 'source_sans_pro' )->add_dependency( 'bootstrap_css' );
			...
			\Habari\StackItem::register( 'bootstrap_js', 'https://b79aa4845dfa0330f3c1-8ab693c01194d150d70d8e544af6f6be.ssl.cf1.rackcdn.com/v2.1.1/full/js/bootstrap.min.js' )->add_dependency( 'jquery' );
			\Habari\StackItem::register( 'theme_js', $theme->get_url( 'assets/js/index.js' ), $theme->version )->add_dependency( 'bootstrap_js' );
			\Habari\StackItem::register( 'modernizr', '//cdnjs.cloudflare.com/ajax/libs/modernizr/2.6.2/modernizr.min.js', '2.6.2' );
			...
			\Habari\Stack::add( 'template_header_javascript', 'modernizr' );
