			...
			<div id="left" class="span4">
				...
				<header id="header" class="vcard">
					<hgroup>
						...
						<h2 id="tagline" itemprop="description"><span class="role">Awesome Coder</span>. Unashamed PHP Lover. Dot Net Dabbler. Mac User. nGinx Enthusiast. Open Data Addict. <a href="https://twitter.com/habari">@habari</a> Cabal Member. System Admin. Nerd.</h2>
					</hgroup>
					<div class="navbar">
