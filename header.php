...
<body class="<?php echo $theme->body_class(); ?>" itemscope itemtype="http://schema.org/Blog">
	...
	<div id="page">
		...
		<div class="row container">
			...
			<div id="left" class="third">
				...
				<div class="inner">
					...
					<header id="header" class="vcard">
						...
						<div>
							<ul class="social links row split">
								<li class="sixth"><a href="https://chrismeller.com" title="Chris Meller" class="icon blog" data-rel="tooltip">Chris Meller</a></li>
								<li class="sixth"><a href="https://github.com/chrismeller" title="GitHub" class="icon github" data-rel="tooltip">Github</a></li>
								<li class="sixth"><a href="https://twitter.com/chrismeller" title="Twitter" class="icon twitter" data-rel="tooltip">Twitter</a></li>
								<li class="sixth"><a href="http://flickr.com/mellertime" title="Flickr" class="icon flickr" data-rel="tooltip">Flickr</a></li>
								<li class="sixth"><a href="https://www.google.com/search?q=mooses&amp;tbm=isch" title="Mooses!" class="icon mooses" data-rel="tooltip">Mooses</a></li>
							</ul>
						</div>
					</header>
			...
			<section id="content" class="twothird">
				<div class="inner">
					<?php
